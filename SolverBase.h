 ...
 * \endcode
 *
 * \warning Currently, any other usage of transpose() and adjoint() are not supported and will produce
 * compilation errors.
 *
 * \sa class PartialPivLU, class FullPivLU, class HouseholderQR, class ColPivHouseholderQR, class
 * FullPivHouseholderQR, class CompleteOrthogonalDecomposition, class LLT, class LDLT, class SVDBase
 */
template <typename Derived>
...
public:
  ...
  {
    internal::solve_assertion<typename internal::remove_all<Derived>::type>::template run<false>(derived(),
                                                                                                 b);
  ...
  typedef typename internal::conditional<
      ...
      const ConstTransposeReturnType>::type AdjointReturnType;
