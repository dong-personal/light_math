...
#undef EIGEN_DOC_UNARY_ADDONS
  ...
  /** \returns true if at least one pair of coefficients of \c *this and \a other are not exactly equal to
   * each other. \warning When using floating point scalar values you probably should rather use a fuzzy
   * comparison such as isApprox() \sa isApprox(), operator== */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC inline bool operator!=(const MatrixBase<OtherDerived>& other) const
  {
...
#define EIGEN_MATRIX_FUNCTION(ReturnType, Name, Description)                                             \
   ...
   * href="unsupported/group__MatrixFunctions__Module.html"> unsupported MatrixFunctions module</a>. To  \
   * compute the coefficient-wise Description use ArrayBase::##Name . */                                 \
