                                                ...
                                                Version>
{
                                      ...
                                      level3_blocking<RhsScalar, LhsScalar>& blocking)
  {
    general_matrix_matrix_triangular_product<
        Index, RhsScalar, RhsStorageOrder == RowMajor ? ColMajor : RowMajor, ConjugateRhs, LhsScalar,
        LhsStorageOrder == RowMajor ? ColMajor : RowMajor, ConjugateLhs, ColMajor, ResInnerStride,
        UpLo == Lower ? Upper : Lower>::run(size, depth, rhs, rhsStride, lhs, lhsStride, res, resIncr,
                                                ...
                                                Version>
{
                                      ...
                                      level3_blocking<LhsScalar, RhsScalar>& blocking)
  {
    ...
    gebp_kernel<LhsScalar, RhsScalar, Index, ResMapper, Traits::mr, Traits::nr, ConjugateLhs, ConjugateRhs>
        gebp;
    tribb_kernel<LhsScalar, RhsScalar, Index, Traits::mr, Traits::nr, ConjugateLhs, ConjugateRhs,
                 ResInnerStride, UpLo>
        sybb;
    ...
    for (Index k2 = 0; k2 < depth; k2 += kc)
    {
      ...
      for (Index i2 = 0; i2 < size; i2 += mc)
      {
        ...
        if (UpLo == Lower)
          gebp(res.getSubMapper(i2, 0), blockA, blockB, actual_mc, actual_kc, (std::min)(size, i2), alpha, -1,
               -1, 0, 0);

        sybb(res_ + resStride * i2 + resIncr * i2, resIncr, resStride, blockA, blockB + actual_kc * i2,
...
struct tribb_kernel
{
  ...
  void operator()(ResScalar* res_, Index resIncr, Index resStride, const LhsScalar* blockA,
                  const RhsScalar* blockB, Index size, Index depth, const ResScalar& alpha)
  {
    ...
    for (Index j = 0; j < size; j += BlockSize)
    {
      ...
      if (UpLo == Upper)
        gebp_kernel1(res.getSubMapper(0, j), blockA, actual_b, j, depth, actualBlockSize, alpha, -1, -1, 0,
                     0);
      ...
      // selfadjoint micro block
      {
        ...
        gebp_kernel2(BufferMapper(buffer.data(), BlockSize), blockA + depth * i, actual_b, actualBlockSize,
      ...
      if (UpLo == Lower)
      {
        ...
        gebp_kernel1(res.getSubMapper(i, j), blockA + depth * i, actual_b, size - i, depth, actualBlockSize,
                     alpha, -1, -1, 0, 0);
      }
    }
  }
...
struct general_product_to_triangular_selector<MatrixType, ProductType, UpLo, false>
{
                  ...
                  bool beta)
  {
    ...
    typename ProductType::Scalar actualAlpha = alpha *
    ...
    typedef internal::gemm_blocking_space<IsRowMajor ? RowMajor : ColMajor, typename Lhs::Scalar,
    ...
    internal::general_matrix_matrix_triangular_product<
        ...
        UpLo&(Lower | Upper)>::run(size, depth,
