 ...
 * matrix \f$ P_\sigma \f$ is such that if \f$ (e_1,\ldots,e_p) \f$ is the canonical basis, we have: \f[
 * P_\sigma(e_i) = e_{\sigma(i)}. \f] This convention ensures that for any two permutations \f$ \sigma, \tau
 * \f$, we have: \f[ P_{\sigma\circ\tau} = P_\sigma P_\tau. \f]
 *
...
public:
  ...
  typedef Matrix<StorageIndex, RowsAtCompileTime, ColsAtCompileTime, 0, MaxRowsAtCompileTime,
...
public:
  ...
  /** \returns the determinant of the permutation matrix, which is either 1 or -1 depending on the parity of
   * the permutation.
   *
...
struct traits<PermutationMatrix<SizeAtCompileTime, MaxSizeAtCompileTime, _StorageIndex> >
    : traits<Matrix<_StorageIndex, SizeAtCompileTime, SizeAtCompileTime, 0, MaxSizeAtCompileTime,
 ...
 * \tparam MaxSizeAtCompileTime the maximum number of rows/cols, or Dynamic. This optional parameter defaults
 * to SizeAtCompileTime. Most of the time, you should not have to specify it. \tparam _StorageIndex the
 * integer type of the indices
 *
...
{
  return Product<MatrixDerived, PermutationDerived, AliasFreeProduct>(matrix.derived(),
                                                                      permutation.derived());
}
...
{
  return Product<PermutationDerived, MatrixDerived, AliasFreeProduct>(permutation.derived(),
                                                                      matrix.derived());
}
