...
public:
  ...
  EIGEN_DEVICE_FUNC
  inline const DiagonalWrapper<const EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(DiagonalVectorType, Scalar,
                                                                            product)>
 ...
 * \param MaxSizeAtCompileTime the dimension of the matrix, or Dynamic. This parameter is optional and
 * defaults to SizeAtCompileTime. Most of the time, you do not need to specify it.
 *
...
struct traits<DiagonalMatrix<_Scalar, SizeAtCompileTime, MaxSizeAtCompileTime>>
    : traits<Matrix<_Scalar, SizeAtCompileTime, SizeAtCompileTime, 0, MaxSizeAtCompileTime,
...
public:
  ...
  /** \brief Constructs a DiagonalMatrix and initializes it by elements given by an initializer list of
   * initializer lists \cpp11
   */
  EIGEN_DEVICE_FUNC
