...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename DenseBase<Derived>::TransposeReturnType
...
struct check_transpose_aliasing_run_time_selector<Scalar, DestIsTransposed,
                                                  CwiseBinaryOp<BinOp, DerivedA, DerivedB> >
{
